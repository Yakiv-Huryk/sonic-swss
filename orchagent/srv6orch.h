...
{
    public:
        Srv6Orch(DBConnector *cfgDb, DBConnector *applDb, vector<string> &tableNames, SwitchOrch *switchOrch, VRFOrch *vrfOrch, NeighOrch *neighOrch);
        ~Srv6Orch()
        {
    ...
    private:
        ...
        bool getMySidEntryDscpMode(const string& my_sid, sai_tunnel_dscp_mode_t& dscp_mode) const;
        ...
        Srv6MySidDscpCfg my_sid_dscp_cfg_;
        VRFOrch *m_vrfOrch;
